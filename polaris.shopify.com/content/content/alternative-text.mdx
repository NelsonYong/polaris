...
- Use simple words. If you’re stuck on how to replace a complicated word, check this [A-Z list of alternative words](https://www.plainenglish.co.uk/the-a-z-of-alternative-words.html) or these [plain language tips](/content/writing-principles). Another good resource is the [Hemingway editor](https://hemingwayapp.com/).
